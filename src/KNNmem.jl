...
mutable struct KNNmemory{T <: Real}
    ...
    """
    function KNNmemory{T}(memorySize::Int, keySize::Int, k::Int, labelCount::Int, α::Real = 0.1) where T
...
function memoryLoss(memory::KNNmemory{T}, q::AbstractArray, nearestPositiveID::Int, nearestNegativeID::Int) where {T}
...
"""
trainQuery!(memory::KNNmemory{T}, q::AbstractArray, v::Int) where {T} = trainQuery!(memory, q, [v])

function trainQuery!(memory::KNNmemory{T}, q::AbstractArray, v::Vector{<:Int}) where {T}
